...
for it in range(4,5):
    ...
    LOG_DIR = '../logs/'
    CLASSES_NUM = 2
    CHECKPOINT_DIR = 'F:/data/targetarea/model/11/' + str(TEST) + "/"
    ...
    with g.as_default():
        ...
        logits, softmax, fc, boundarys, feature = inference_seg1(images, CLASSES_NUM, is_training=True, reuse=False)
