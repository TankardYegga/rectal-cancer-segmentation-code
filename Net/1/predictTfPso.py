...
from Net.model import inference_seg1,inference_node1
...
for it in range(5):
    ...
    CHECKPOINT_FILE = 'F:/data/targetarea/model/11/' + str(TEST) + "/"
    save_path = 'F:/data/targetarea/result/11/' + str(TEST) + "/"
    ...
    with tf.Graph().as_default() as g:
        ...
        _, softmax, fc, boundarys, feature = inference_seg1(images, CLASSES_NUM, is_training=False, reuse=False)
        ...
        node_pred = final_node[2][params['Node2'] // 2, :, :]
